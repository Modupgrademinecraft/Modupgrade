...
public class CrackedDioriteBricksStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:cracked_diorite_bricks_stairs")
	public static final Block block = null;
	public CrackedDioriteBricksStairsBlock(ModXrtModElements instance) {
		super(instance, 372);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cracked_diorite_bricks_stairs");
		}
