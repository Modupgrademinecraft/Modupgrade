...
public class BlueconcreteslabBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:blueconcreteslab")
	public static final Block block = null;
	public BlueconcreteslabBlock(ModXrtModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blueconcreteslab");
		}
