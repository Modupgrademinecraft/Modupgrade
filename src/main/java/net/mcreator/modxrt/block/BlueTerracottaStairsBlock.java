...
public class BlueTerracottaStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:blue_terracotta_stairs")
	public static final Block block = null;
	public BlueTerracottaStairsBlock(ModXrtModElements instance) {
		super(instance, 417);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_terracotta_stairs");
		}
