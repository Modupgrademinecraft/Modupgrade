...
public class CrackedStoneBricksWallBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:cracked_stone_bricks_wall")
	public static final Block block = null;
	public CrackedStoneBricksWallBlock(ModXrtModElements instance) {
		super(instance, 236);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("cracked_stone_bricks_wall");
		}
