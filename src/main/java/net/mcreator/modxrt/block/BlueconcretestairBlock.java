...
public class BlueconcretestairBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:blueconcretestair")
	public static final Block block = null;
	public BlueconcretestairBlock(ModXrtModElements instance) {
		super(instance, 32);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blueconcretestair");
		}
