...
public class MossyAndesiteBricksBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:mossy_andesite_bricks")
	public static final Block block = null;
	public MossyAndesiteBricksBlock(ModXrtModElements instance) {
		super(instance, 282);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_andesite_bricks");
		}
