...
public class LimeconcretestairBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:limeconcretestair")
	public static final Block block = null;
	public LimeconcretestairBlock(ModXrtModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("limeconcretestair");
		}
