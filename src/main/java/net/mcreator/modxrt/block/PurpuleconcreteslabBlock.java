...
public class PurpuleconcreteslabBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:purpuleconcreteslab")
	public static final Block block = null;
	public PurpuleconcreteslabBlock(ModXrtModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("purpuleconcreteslab");
		}
