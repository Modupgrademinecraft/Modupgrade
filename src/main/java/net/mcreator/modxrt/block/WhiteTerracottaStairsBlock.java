...
public class WhiteTerracottaStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:white_terracotta_stairs")
	public static final Block block = null;
	public WhiteTerracottaStairsBlock(ModXrtModElements instance) {
		super(instance, 404);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("white_terracotta_stairs");
		}
