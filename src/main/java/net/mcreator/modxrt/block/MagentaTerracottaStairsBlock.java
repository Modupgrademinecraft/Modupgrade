...
public class MagentaTerracottaStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:magenta_terracotta_stairs")
	public static final Block block = null;
	public MagentaTerracottaStairsBlock(ModXrtModElements instance) {
		super(instance, 409);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("magenta_terracotta_stairs");
		}
