...
public class CyanconcretestairBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:cyanconcretestair")
	public static final Block block = null;
	public CyanconcretestairBlock(ModXrtModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cyanconcretestair");
		}
