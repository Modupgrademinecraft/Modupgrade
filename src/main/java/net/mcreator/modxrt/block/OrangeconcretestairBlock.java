...
public class OrangeconcretestairBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:orangeconcretestair")
	public static final Block block = null;
	public OrangeconcretestairBlock(ModXrtModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("orangeconcretestair");
		}
