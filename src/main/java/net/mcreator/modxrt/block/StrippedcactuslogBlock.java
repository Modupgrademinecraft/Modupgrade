...
public class StrippedcactuslogBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:strippedcactuslog")
	public static final Block block = null;
	public StrippedcactuslogBlock(ModXrtModElements instance) {
		super(instance, 86);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("strippedcactuslog");
		}
