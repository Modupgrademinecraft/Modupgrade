...
public class MossyandesitestairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:mossyandesitestairs")
	public static final Block block = null;
	public MossyandesitestairsBlock(ModXrtModElements instance) {
		super(instance, 146);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mossyandesitestairs");
		}
