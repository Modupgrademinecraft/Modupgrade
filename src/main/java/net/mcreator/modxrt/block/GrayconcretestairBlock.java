...
public class GrayconcretestairBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:grayconcretestair")
	public static final Block block = null;
	public GrayconcretestairBlock(ModXrtModElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("grayconcretestair");
		}
