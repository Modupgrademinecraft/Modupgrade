...
public class CactusplanksBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:cactusplanks")
	public static final Block block = null;
	public CactusplanksBlock(ModXrtModElements instance) {
		super(instance, 70);
	}
