...
public class GraniteBricksSlabBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:granite_bricks_slab")
	public static final Block block = null;
	public GraniteBricksSlabBlock(ModXrtModElements instance) {
		super(instance, 315);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("granite_bricks_slab");
		}
