...
public class SmoothstonestairBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:smoothstonestair")
	public static final Block block = null;
	public SmoothstonestairBlock(ModXrtModElements instance) {
		super(instance, 223);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("smoothstonestair");
		}
