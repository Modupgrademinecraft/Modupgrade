...
public class PurpulconcretestairBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:purpulconcretestair")
	public static final Block block = null;
	public PurpulconcretestairBlock(ModXrtModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("purpulconcretestair");
		}
