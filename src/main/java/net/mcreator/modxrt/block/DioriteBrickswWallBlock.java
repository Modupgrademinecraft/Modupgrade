...
public class DioriteBrickswWallBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:diorite_bricksw_wall")
	public static final Block block = null;
	public DioriteBrickswWallBlock(ModXrtModElements instance) {
		super(instance, 357);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("diorite_bricksw_wall");
		}
