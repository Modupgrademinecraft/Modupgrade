...
public class CrackedDioriteBricksWallBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:cracked_diorite_bricks_wall")
	public static final Block block = null;
	public CrackedDioriteBricksWallBlock(ModXrtModElements instance) {
		super(instance, 378);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("cracked_diorite_bricks_wall");
		}
