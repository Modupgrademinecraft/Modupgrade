...
public class MossyGraniteBricksBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:mossy_granite_bricks")
	public static final Block block = null;
	public MossyGraniteBricksBlock(ModXrtModElements instance) {
		super(instance, 321);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_granite_bricks");
		}
