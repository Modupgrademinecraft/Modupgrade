...
public class MossyandesitewallBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:mossyandesitewall")
	public static final Block block = null;
	public MossyandesitewallBlock(ModXrtModElements instance) {
		super(instance, 148);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mossyandesitewall");
		}
