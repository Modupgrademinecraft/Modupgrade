...
public class BrownconcretestairBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:brownconcretestair")
	public static final Block block = null;
	public BrownconcretestairBlock(ModXrtModElements instance) {
		super(instance, 31);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("brownconcretestair");
		}
