...
public class AndesiteBricksStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:andesite_bricks_stairs")
	public static final Block block = null;
	public AndesiteBricksStairsBlock(ModXrtModElements instance) {
		super(instance, 272);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("andesite_bricks_stairs");
		}
