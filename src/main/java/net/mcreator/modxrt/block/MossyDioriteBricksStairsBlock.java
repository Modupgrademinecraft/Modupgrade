...
public class MossyDioriteBricksStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:mossy_diorite_bricks_stairs")
	public static final Block block = null;
	public MossyDioriteBricksStairsBlock(ModXrtModElements instance) {
		super(instance, 362);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_diorite_bricks_stairs");
		}
