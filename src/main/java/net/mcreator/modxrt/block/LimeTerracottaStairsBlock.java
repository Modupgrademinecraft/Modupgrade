...
public class LimeTerracottaStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:lime_terracotta_stairs")
	public static final Block block = null;
	public LimeTerracottaStairsBlock(ModXrtModElements instance) {
		super(instance, 410);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("lime_terracotta_stairs");
		}
