...
public class BlockdepoudreacanonBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:blockdepoudreacanon")
	public static final Block block = null;
	public BlockdepoudreacanonBlock(ModXrtModElements instance) {
		super(instance, 155);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("blockdepoudreacanon");
		}
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				{
					...
					BlockdepoudreacanonRedstoneOnProcedure.executeProcedure($_dependencies);
				}
			} else {
			}
		}
