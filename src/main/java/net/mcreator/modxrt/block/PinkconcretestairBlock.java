...
public class PinkconcretestairBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:pinkconcretestair")
	public static final Block block = null;
	public PinkconcretestairBlock(ModXrtModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("pinkconcretestair");
		}
