...
public class LightGrayTerracottaStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:light_gray_terracotta_stairs")
	public static final Block block = null;
	public LightGrayTerracottaStairsBlock(ModXrtModElements instance) {
		super(instance, 411);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("light_gray_terracotta_stairs");
		}
