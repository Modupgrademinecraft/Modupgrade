...
public class GraniteBricksBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:granite_bricks")
	public static final Block block = null;
	public GraniteBricksBlock(ModXrtModElements instance) {
		super(instance, 310);
	}
