...
public class MossyGraniteBricksWallBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:mossy_granite_bricks_wall")
	public static final Block block = null;
	public MossyGraniteBricksWallBlock(ModXrtModElements instance) {
		super(instance, 329);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_granite_bricks_wall");
		}
