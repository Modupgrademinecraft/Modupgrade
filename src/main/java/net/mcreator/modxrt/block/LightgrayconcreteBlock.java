...
public class LightgrayconcreteBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:lightgrayconcrete")
	public static final Block block = null;
	public LightgrayconcreteBlock(ModXrtModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("lightgrayconcrete");
		}
