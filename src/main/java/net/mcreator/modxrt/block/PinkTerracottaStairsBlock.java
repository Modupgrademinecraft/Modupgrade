...
public class PinkTerracottaStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:pink_terracotta_stairs")
	public static final Block block = null;
	public PinkTerracottaStairsBlock(ModXrtModElements instance) {
		super(instance, 407);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("pink_terracotta_stairs");
		}
