...
public class MossyDioriteBricksWallBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:mossy_diorite_bricks_wall")
	public static final Block block = null;
	public MossyDioriteBricksWallBlock(ModXrtModElements instance) {
		super(instance, 367);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_diorite_bricks_wall");
		}
