...
public class MossyAndesiteBricksWallBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:mossy_andesite_bricks_wall")
	public static final Block block = null;
	public MossyAndesiteBricksWallBlock(ModXrtModElements instance) {
		super(instance, 290);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_andesite_bricks_wall");
		}
