...
public class PurpuleTerracottaStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:purpule_terracotta_stairs")
	public static final Block block = null;
	public PurpuleTerracottaStairsBlock(ModXrtModElements instance) {
		super(instance, 406);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("purpule_terracotta_stairs");
		}
