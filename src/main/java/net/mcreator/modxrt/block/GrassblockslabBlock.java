...
public class GrassblockslabBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:grassblockslab")
	public static final Block block = null;
	public GrassblockslabBlock(ModXrtModElements instance) {
		super(instance, 517);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("grassblockslab");
		}
