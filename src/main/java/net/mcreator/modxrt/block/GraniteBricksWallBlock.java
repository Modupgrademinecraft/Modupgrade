...
public class GraniteBricksWallBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:granite_bricks_wall")
	public static final Block block = null;
	public GraniteBricksWallBlock(ModXrtModElements instance) {
		super(instance, 318);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("granite_bricks_wall");
		}
