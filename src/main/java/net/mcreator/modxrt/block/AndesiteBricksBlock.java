...
public class AndesiteBricksBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:andesite_bricks")
	public static final Block block = null;
	public AndesiteBricksBlock(ModXrtModElements instance) {
		super(instance, 237);
	}
