...
public class GrayTerracottaStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:gray_terracotta_stairs")
	public static final Block block = null;
	public GrayTerracottaStairsBlock(ModXrtModElements instance) {
		super(instance, 414);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("gray_terracotta_stairs");
		}
