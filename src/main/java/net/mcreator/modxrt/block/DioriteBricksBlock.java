...
public class DioriteBricksBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:diorite_bricks")
	public static final Block block = null;
	public DioriteBricksBlock(ModXrtModElements instance) {
		super(instance, 349);
	}
