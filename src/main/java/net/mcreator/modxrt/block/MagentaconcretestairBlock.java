...
public class MagentaconcretestairBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:magentaconcretestair")
	public static final Block block = null;
	public MagentaconcretestairBlock(ModXrtModElements instance) {
		super(instance, 24);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("magentaconcretestair");
		}
