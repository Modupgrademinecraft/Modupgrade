...
public class MossydioritestairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:mossydioritestairs")
	public static final Block block = null;
	public MossydioritestairsBlock(ModXrtModElements instance) {
		super(instance, 150);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mossydioritestairs");
		}
