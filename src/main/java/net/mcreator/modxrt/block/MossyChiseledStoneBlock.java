...
public class MossyChiseledStoneBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:mossy_chiseled_stone")
	public static final Block block = null;
	public MossyChiseledStoneBlock(ModXrtModElements instance) {
		super(instance, 224);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_chiseled_stone");
		}
