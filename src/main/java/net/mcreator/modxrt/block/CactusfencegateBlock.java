...
public class CactusfencegateBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:cactusfencegate")
	public static final Block block = null;
	public CactusfencegateBlock(ModXrtModElements instance) {
		super(instance, 99);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("cactusfencegate");
		}
