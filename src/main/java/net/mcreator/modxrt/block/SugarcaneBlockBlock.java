...
public class SugarcaneBlockBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:sugarcane_block")
	public static final Block block = null;
	public SugarcaneBlockBlock(ModXrtModElements instance) {
		super(instance, 217);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("sugarcane_block");
		}
