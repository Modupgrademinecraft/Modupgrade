...
public class CrackedGraniteBricksBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:cracked_granite_bricks")
	public static final Block block = null;
	public CrackedGraniteBricksBlock(ModXrtModElements instance) {
		super(instance, 332);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cracked_granite_bricks");
		}
