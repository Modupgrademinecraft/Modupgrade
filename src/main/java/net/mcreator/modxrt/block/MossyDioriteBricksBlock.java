...
public class MossyDioriteBricksBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:mossy_diorite_bricks")
	public static final Block block = null;
	public MossyDioriteBricksBlock(ModXrtModElements instance) {
		super(instance, 360);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_diorite_bricks");
		}
