...
public class BambooblockBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:bambooblock")
	public static final Block block = null;
	public BambooblockBlock(ModXrtModElements instance) {
		super(instance, 220);
	}
