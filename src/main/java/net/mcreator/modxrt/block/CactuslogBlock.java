...
import net.mcreator.modxrt.procedures.CactuslogOnBlockRightClickedProcedure;
...
public class CactuslogBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:cactuslog")
	public static final Block block = null;
	public CactuslogBlock(ModXrtModElements instance) {
		super(instance, 66);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				CactuslogOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
