...
public class WhiteconcretestairBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:whiteconcretestair")
	public static final Block block = null;
	public WhiteconcretestairBlock(ModXrtModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("whiteconcretestair");
		}
