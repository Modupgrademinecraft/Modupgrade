...
public class AndesiteBricksWallBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:andesite_bricks_wall")
	public static final Block block = null;
	public AndesiteBricksWallBlock(ModXrtModElements instance) {
		super(instance, 279);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("andesite_bricks_wall");
		}
