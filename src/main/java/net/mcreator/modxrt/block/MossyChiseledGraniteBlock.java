...
public class MossyChiseledGraniteBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:mossy_chiseled_granite")
	public static final Block block = null;
	public MossyChiseledGraniteBlock(ModXrtModElements instance) {
		super(instance, 345);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_chiseled_granite");
		}
