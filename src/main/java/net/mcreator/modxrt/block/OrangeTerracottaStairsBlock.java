...
public class OrangeTerracottaStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:orange_terracotta_stairs")
	public static final Block block = null;
	public OrangeTerracottaStairsBlock(ModXrtModElements instance) {
		super(instance, 408);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("orange_terracotta_stairs");
		}
