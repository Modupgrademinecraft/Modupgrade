...
public class PinkconcreteslabBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:pinkconcreteslab")
	public static final Block block = null;
	public PinkconcreteslabBlock(ModXrtModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("pinkconcreteslab");
		}
