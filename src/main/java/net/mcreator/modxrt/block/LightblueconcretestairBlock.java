...
public class LightblueconcretestairBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:lightblueconcretestair")
	public static final Block block = null;
	public LightblueconcretestairBlock(ModXrtModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("lightblueconcretestair");
		}
