...
public class BlackconcretestairBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:blackconcretestair")
	public static final Block block = null;
	public BlackconcretestairBlock(ModXrtModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blackconcretestair");
		}
