...
public class LeatherblockBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:leatherblock")
	public static final Block block = null;
	public LeatherblockBlock(ModXrtModElements instance) {
		super(instance, 208);
	}
