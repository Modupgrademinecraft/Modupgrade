...
public class CrackedGraniteBricksWallBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:cracked_granite_bricks_wall")
	public static final Block block = null;
	public CrackedGraniteBricksWallBlock(ModXrtModElements instance) {
		super(instance, 340);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("cracked_granite_bricks_wall");
		}
