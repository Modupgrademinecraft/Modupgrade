...
public class MossydioritewallBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:mossydioritewall")
	public static final Block block = null;
	public MossydioritewallBlock(ModXrtModElements instance) {
		super(instance, 152);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mossydioritewall");
		}
