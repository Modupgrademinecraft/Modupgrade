...
public class GraniteBricksStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:granite_bricks_stairs")
	public static final Block block = null;
	public GraniteBricksStairsBlock(ModXrtModElements instance) {
		super(instance, 312);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("granite_bricks_stairs");
		}
