...
public class BrownTerracottaStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:brown_terracotta_stairs")
	public static final Block block = null;
	public BrownTerracottaStairsBlock(ModXrtModElements instance) {
		super(instance, 416);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("brown_terracotta_stairs");
		}
