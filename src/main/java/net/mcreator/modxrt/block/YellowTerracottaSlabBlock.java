...
public class YellowTerracottaSlabBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:yellow_terracotta_slab")
	public static final Block block = null;
	public YellowTerracottaSlabBlock(ModXrtModElements instance) {
		super(instance, 387);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("yellow_terracotta_slab");
		}
