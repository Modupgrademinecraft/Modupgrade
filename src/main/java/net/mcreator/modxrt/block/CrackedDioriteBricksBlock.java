...
public class CrackedDioriteBricksBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:cracked_diorite_bricks")
	public static final Block block = null;
	public CrackedDioriteBricksBlock(ModXrtModElements instance) {
		super(instance, 370);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cracked_diorite_bricks");
		}
