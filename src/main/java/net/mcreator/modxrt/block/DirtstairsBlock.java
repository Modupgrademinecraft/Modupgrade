...
public class DirtstairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:dirtstairs")
	public static final Block block = null;
	public DirtstairsBlock(ModXrtModElements instance) {
		super(instance, 106);
	}
