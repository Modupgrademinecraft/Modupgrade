...
public class ChiseledAndesiteBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:chiseled_andesite")
	public static final Block block = null;
	public ChiseledAndesiteBlock(ModXrtModElements instance) {
		super(instance, 304);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_andesite");
		}
