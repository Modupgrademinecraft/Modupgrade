...
public class GreenconcretestairBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:greenconcretestair")
	public static final Block block = null;
	public GreenconcretestairBlock(ModXrtModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("greenconcretestair");
		}
