...
public class MossyDioriteBricksSlabBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:mossy_diorite_bricks_slab")
	public static final Block block = null;
	public MossyDioriteBricksSlabBlock(ModXrtModElements instance) {
		super(instance, 364);
	}
