...
public class LightBlueTerracottaStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:light_blue_terracotta_stairs")
	public static final Block block = null;
	public LightBlueTerracottaStairsBlock(ModXrtModElements instance) {
		super(instance, 412);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("light_blue_terracotta_stairs");
		}
