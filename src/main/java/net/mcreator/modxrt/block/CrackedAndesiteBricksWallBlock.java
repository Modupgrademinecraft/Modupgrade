...
public class CrackedAndesiteBricksWallBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:cracked_andesite_bricks_wall")
	public static final Block block = null;
	public CrackedAndesiteBricksWallBlock(ModXrtModElements instance) {
		super(instance, 301);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5f, 10f).lightValue(0).notSolid());
			setRegistryName("cracked_andesite_bricks_wall");
		}
