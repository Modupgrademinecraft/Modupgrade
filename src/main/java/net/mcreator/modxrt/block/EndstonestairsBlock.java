...
public class EndstonestairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:endstonestairs")
	public static final Block block = null;
	public EndstonestairsBlock(ModXrtModElements instance) {
		super(instance, 116);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("endstonestairs");
		}
