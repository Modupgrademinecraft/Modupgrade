...
public class MossyGraniteBricksStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:mossy_granite_bricks_stairs")
	public static final Block block = null;
	public MossyGraniteBricksStairsBlock(ModXrtModElements instance) {
		super(instance, 323);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_granite_bricks_stairs");
		}
