...
public class AndesiteBricksSlabBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:andesite_bricks_slab")
	public static final Block block = null;
	public AndesiteBricksSlabBlock(ModXrtModElements instance) {
		super(instance, 275);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("andesite_bricks_slab");
		}
