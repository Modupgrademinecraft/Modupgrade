...
public class BlackTerracottaStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:black_terracotta_stairs")
	public static final Block block = null;
	public BlackTerracottaStairsBlock(ModXrtModElements instance) {
		super(instance, 418);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("black_terracotta_stairs");
		}
