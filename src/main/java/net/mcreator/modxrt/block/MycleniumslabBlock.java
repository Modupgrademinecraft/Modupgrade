...
public class MycleniumslabBlock extends ModXrtModElements.ModElement {

	@ObjectHolder("mod_xrt:mycleniumslab")
	public static final Block block = null;

	public MycleniumslabBlock(ModXrtModElements instance) {
		super(instance, 513);
