...
public class CyanTerracottaStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:cyan_terracotta_stairs")
	public static final Block block = null;
	public CyanTerracottaStairsBlock(ModXrtModElements instance) {
		super(instance, 415);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cyan_terracotta_stairs");
		}
