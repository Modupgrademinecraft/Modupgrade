...
public class GreenTerracottaStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:green_terracotta_stairs")
	public static final Block block = null;
	public GreenTerracottaStairsBlock(ModXrtModElements instance) {
		super(instance, 413);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("green_terracotta_stairs");
		}
