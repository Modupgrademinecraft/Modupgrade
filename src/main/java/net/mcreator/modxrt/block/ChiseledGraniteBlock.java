...
public class ChiseledGraniteBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:chiseled_granite")
	public static final Block block = null;
	public ChiseledGraniteBlock(ModXrtModElements instance) {
		super(instance, 343);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_granite");
		}
