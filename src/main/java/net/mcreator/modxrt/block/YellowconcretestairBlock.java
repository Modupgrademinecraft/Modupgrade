...
public class YellowconcretestairBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:yellowconcretestair")
	public static final Block block = null;
	public YellowconcretestairBlock(ModXrtModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("yellowconcretestair");
		}
