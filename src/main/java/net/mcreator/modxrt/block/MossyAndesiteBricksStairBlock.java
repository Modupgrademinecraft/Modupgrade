...
public class MossyAndesiteBricksStairBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:mossy_andesite_bricks_stair")
	public static final Block block = null;
	public MossyAndesiteBricksStairBlock(ModXrtModElements instance) {
		super(instance, 284);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_andesite_bricks_stair");
		}
