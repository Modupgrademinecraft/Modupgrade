...
public class CrackedAndesiteBricksStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:cracked_andesite_bricks_stairs")
	public static final Block block = null;
	public CrackedAndesiteBricksStairsBlock(ModXrtModElements instance) {
		super(instance, 295);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cracked_andesite_bricks_stairs");
		}
