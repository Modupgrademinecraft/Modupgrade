...
public class RedconcretestairBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:redconcretestair")
	public static final Block block = null;
	public RedconcretestairBlock(ModXrtModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("redconcretestair");
		}
