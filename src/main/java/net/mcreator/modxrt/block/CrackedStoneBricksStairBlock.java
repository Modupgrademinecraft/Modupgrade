...
public class CrackedStoneBricksStairBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:cracked_stone_bricks_stair")
	public static final Block block = null;
	public CrackedStoneBricksStairBlock(ModXrtModElements instance) {
		super(instance, 228);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cracked_stone_bricks_stair");
		}
