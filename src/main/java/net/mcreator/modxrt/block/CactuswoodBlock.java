...
public class CactuswoodBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:cactuswood")
	public static final Block block = null;
	public CactuswoodBlock(ModXrtModElements instance) {
		super(instance, 68);
	}
