...
public class DioriteBricksStairsBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:diorite_bricks_stairs")
	public static final Block block = null;
	public DioriteBricksStairsBlock(ModXrtModElements instance) {
		super(instance, 351);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("diorite_bricks_stairs");
		}
