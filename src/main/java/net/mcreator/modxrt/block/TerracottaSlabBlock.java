...
public class TerracottaSlabBlock extends ModXrtModElements.ModElement {
	@ObjectHolder("mod_xrt:terracotta_slab")
	public static final Block block = null;
	public TerracottaSlabBlock(ModXrtModElements instance) {
		super(instance, 419);
	}
